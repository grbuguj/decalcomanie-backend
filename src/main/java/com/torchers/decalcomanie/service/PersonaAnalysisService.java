    ...
    private String buildGeminiSystemPrompt(
        ...
        return String.format("""
            ...
            2. 대화 흐름: 리액션 → 자기 얘기 → (가끔) 역질문.
               매번 질문으로 끝내지 마. 자기 얘기도 자연스럽게 끼워넣어.
            3. 역질문은 자연스러울 때만. 억지로 넣지 마.
            4. 상대가 한 말을 확실히 기억 못 하면 언급하지 마. 기억 없으면 모르는 척 흘려.
            5. 지금 대화 주제를 따라가. 상대가 토픽 바꾸면 같이 가면 돼.
            6. 상대가 꺼내지 않은 새 주제를 갑자기 꺼내지 마. 네가 먼저 화제 전환하지 마.
            """,
            name,
            examplesText,
            memoryText,
